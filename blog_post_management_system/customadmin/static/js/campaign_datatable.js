    ...
    columns: [
      {
        render: function (data, type, JsonResultRow, meta) {
          return `
            <div onclick="location.href='/admin/campaign/${JsonResultRow._id}/update'" style="display: flex;justify-content: start;gap: 0 15px;align-items: center;">
              <img width="50px" style="border-radius: 50%;object-fit: cover;"  height="50px" alt="company-logo" src="${JsonResultRow.picture}">
              <a  class="link-dark" href="/admin/campaign/${JsonResultRow._id}/update">${JsonResultRow.title}</a>
            </div>`;
        },
        data: "title",
        name: "title",
