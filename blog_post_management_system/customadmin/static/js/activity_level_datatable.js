    ...
    columns: [
      {
        render: function (data, type, JsonResultRow, meta) {
          return `<div class="abc" onclick="location.href='/admin/level/${JsonResultRow._id}/update'">
                    <a class="link-dark w-100" href="/admin/level/${JsonResultRow._id}/update">${JsonResultRow.name}</a>
              </div>`;
        },
        data: "name",
        name: "name",
